...
public class PercolateContext extends SearchContext {
    ...
    public SearchLookup lookup() {
        if (searchLookup == null) {
            searchLookup = new SearchLookup(mapperService(), fieldData(), new String[]{request.documentType()});
        }
        return searchLookup;
    }
    ...
    public boolean release() throws ElasticSearchException {
        if (engineSearcher != null) {
            fieldDataService.clear(indexSearcher().getIndexReader());
    ...
    @Override
    public String[] types() {
        return new String[]{request.documentType()};
    }
