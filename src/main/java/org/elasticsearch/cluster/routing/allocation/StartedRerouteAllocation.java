...
public class StartedRerouteAllocation extends RoutingAllocation {
    ...
    public StartedRerouteAllocation(AllocationDeciders deciders, RoutingNodes routingNodes, ClusterState state, List<? extends ShardRouting> startedShards, ClusterInfo clusterInfo) {
        super(deciders, routingNodes, state, clusterInfo);
