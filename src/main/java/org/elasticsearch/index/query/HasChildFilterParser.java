...
public class HasChildFilterParser implements FilterParser {
    ...
    public Filter parse(QueryParseContext parseContext) throws IOException, QueryParsingException {
        ...
        Query childrenQuery = HasChildQueryParser.createChildrenQuery(parseContext, childType, ScoreType.NONE, minChildren, maxChildren, shortCircuitParentDocSet, innerHits, query, strict);
