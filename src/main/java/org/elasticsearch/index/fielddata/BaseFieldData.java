...
/**
 */
public interface BaseFieldData extends IndexComponent {
    ...
    interface Builder {
        ...
        BaseFieldData build(Index index, @IndexSettings Settings indexSettings, FieldMapper<?> mapper, IndexFieldDataCache cache,
