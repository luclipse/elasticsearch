...
public class ValueHistogramFacetExecutor extends FacetExecutor {
    ...
    public ValueHistogramFacetExecutor(IndexNumericFieldData keyIndexFieldData, IndexNumericFieldData valueIndexFieldData, long interval, HistogramFacet.ComparatorType comparatorType, SearchParseContext context) {
