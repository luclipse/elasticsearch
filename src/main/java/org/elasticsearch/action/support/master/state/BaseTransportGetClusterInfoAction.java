...
/**
 */
public abstract class BaseTransportGetClusterInfoAction<Request extends BaseGetClusterStateInfoRequest, Response extends ActionResponse> extends TransportMasterNodeOperationAction<Request, Response> {

    public BaseTransportGetClusterInfoAction(Settings settings, TransportService transportService, ClusterService clusterService, ThreadPool threadPool) {
