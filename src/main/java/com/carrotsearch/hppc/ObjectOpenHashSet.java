 ...
 */
@javax.annotation.Generated(date = "2013-11-10T19:21:43+0100", value = "HPPC generated from: ObjectOpenHashSet.java")
        ...
        implements ObjectLookupContainer<KType>, ObjectSet<KType>, Cloneable
{
    ...
    public boolean ladd(KType e)
    {
        // Check if we need to grow. If so, reallocate new data,
        // fill in the last element and rehash.
        if (assigned == resizeAt) {
            expandAndAdd(e, lastSlot);
        } else {
            assigned++;
            allocated[lastSlot] = true;
            keys[lastSlot] = e;
        }
        return true;
    }
