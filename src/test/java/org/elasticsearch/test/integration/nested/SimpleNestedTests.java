...
public class SimpleNestedTests extends AbstractNodesTests {
    ...
    @Test
    // When IncludeAllNestedDocsQuery is wrapped in a FilteredQuery then a in-finite loop occurs b/c of a bug in IncludeAllNestedDocsQuery#advance()
    // This IncludeAllNestedDocsQuery also needs to be aware of the filter from alias
